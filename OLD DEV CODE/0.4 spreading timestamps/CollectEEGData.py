# Obtained from:
# https://brainflow.readthedocs.io/en/stable/DataFormatDesc.html#special-channels-for-openbci-cyton-based-boards

# Run from command line:
# python CollectEEGData.py --board-id 0 --serial-port COM5
...
def main ():
    ...
    DataFilter.write_file (data, 'cyton_data.txt', 'w')
